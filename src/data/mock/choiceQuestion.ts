...
export const MOCK_CHOICE_QUESTION_SET: ChoiceQuestionSet = {
  ...
  questions: [
    // ── 단어 학습 카드 (type: "word") ──────────────────────────
    {
      questionNumber: 1,
      type: "word",
      flavorText: "부동산 핵심 용어",
      passage: "임차인(세입자)이 집주인에게 목돈을 맡기고 계약 기간 동안 무이자로 거주하는 임대 방식. 계약 만료 시 보증금 전액을 돌려받습니다.",
      question: "전세란?",
      choices: ["전세"],
      correctIndex: 0,
      imageUrl: "",
      imageAlt: "전세 개념 이미지",
      explanation: "전세 보증금은 집값의 50~80% 수준인 경우가 많아요. 시세 대비 보증금 비율이 높을수록 위험할 수 있습니다.",
    },
    {
      questionNumber: 2,
      type: "word",
      flavorText: "부동산 핵심 용어",
      passage: "임차인이 집주인에게 맡기는 목돈. 전세에선 집값의 절반 이상이 되기도 하며, 계약 종료 후 반드시 돌려받아야 합니다.",
      question: "보증금이란?",
      choices: ["보증금"],
      correctIndex: 0,
      imageUrl: "",
      imageAlt: "보증금 개념 이미지",
      explanation: "보증금을 돌려받지 못하는 '전세 사기'를 예방하려면 등기부등본 확인과 전세보증보험 가입이 중요합니다.",
    },
    {
      questionNumber: 3,
      type: "word",
      flavorText: "부동산 핵심 용어",
      passage: "아파트·빌라 등에서 실제로 생활하는 공간의 면적. 공용 복도·계단·주차장 등은 제외됩니다. 계약 전 반드시 확인하세요.",
      question: "전용면적이란?",
      choices: ["전용면적"],
      correctIndex: 0,
      imageUrl: "",
      imageAlt: "전용면적 개념 이미지",
      explanation: "분양 광고의 '59㎡', '84㎡' 는 모두 전용면적 기준입니다. 공급면적(전용+공용)과 혼동하지 마세요!",
    },
    // ── 퀴즈 문제 (type: "quiz") ───────────────────────────────
    {
      questionNumber: 4,
