...
export const DASHBOARD_CATEGORIES: DashboardCategory[] = [
  { name: "부동산 · 주거", lessons: 12, percent: 72, emoji: "🏠" },
  { name: "생활금융 · 고용", lessons: 8, percent: 38, emoji: "💳" },
  { name: "커리어 · 세무", lessons: 15, percent: 84, emoji: "💼" },
  { name: "자산운용 · 투자", lessons: 15, percent: 84, emoji: "📈" },
]
