  ...
  return (
    <article className="mt-12">
      <div className="flex items-center justify-between px-1 mb-5">
        ...
        <Button variant="link" size="sm" className="h-auto p-0 text-slate-400 text-xs font-bold hover:text-slate-900 uppercase tracking-widest">
          View All
        </Button>
      </div>
      ...
      <div className="hide-scrollbar -mx-5 flex gap-4 overflow-x-auto px-5 pb-4">
        {categories.map((category) => (
          <Button
            key={category.name}
            variant="outline"
            className="flex h-auto min-w-[160px] flex-col items-start rounded-[32px] border-2 border-slate-100 bg-white p-6 transition-all hover:border-slate-300 active:scale-95 shadow-sm"
          >
            ...
            <div className="text-left w-full">
              ...
              <p className="text-xs font-medium text-slate-400 uppercase tracking-tighter">{category.lessons} Chapters</p>
            </div>
